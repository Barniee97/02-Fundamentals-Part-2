...
//answer2
let scoreDolphins = calcAverage(20, 20, 20);
let scoreKoalas = calcAverage(40, 20, 20);
console.log(scoreDolphins, scoreKoalas);
...
console.log(`${john.fullName}'s BMI (${john.calcBMI()}) is ${john.calcBMI() > mark.calcBMI() ? "higher" : "lesser"} than ${mark.fullName}'s (${mark.calcBMI()})!`);
